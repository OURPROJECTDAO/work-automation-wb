...
| channel-margin-monitor (채널 가격·마진 모니터) | — | 운영중 (6채널 전부 모니터+가격변경) | workflows/channel-margin-monitor.md |
