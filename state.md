...
| intelligence-layer (지능 레이어·이력엔진+두뇌) | — | 진행중 (1a·1b·두뇌①·주문적재·판매가검증·**P2 송장실배분** 완료) | workflows/intelligence-layer.md |
...
## 다음 한 수
- **★★ 재개점 (2026-06-15): P2 송장 실배분 ✅완료. 다음 작업=② 2025 주문 백필. 로드맵 정본=systemmap.json.**
  ...
  - **확정 순서(2026-06-15)**: ① **P2 송장 실배분→진짜 마진** ✅완료(core ship_alloc.py·대시보드 추정송장·k 교체) → ② **2025 주문 백필**(EasyAdmin 확장주문검색 .xls 2025 추가적재·컨테이너) → ③ **두뇌③ 채널 가격 A/B**(신규 페이지). **velocity 가중=후순위(지금 불요).** 상세 우선순위 정본=systemmap.json intelligence-layer.roadmap.
