...
| channel-margin-monitor (채널 가격·마진 모니터) | — | 운영중 (6채널: 5 모니터+가격변경 · 올웨이즈 모니터) | workflows/channel-margin-monitor.md |
