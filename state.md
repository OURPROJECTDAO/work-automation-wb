...
| channel-margin-monitor (채널 가격·마진 모니터) | — | 운영중 (4채널, 배민상회만 가격변경 후속) | workflows/channel-margin-monitor.md |
