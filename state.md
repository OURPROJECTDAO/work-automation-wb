...
| channel-margin-monitor (채널 가격·마진 모니터) | — | 운영중 (스마트스토어·식봄·캐시노트·배민상회) | workflows/channel-margin-monitor.md |
