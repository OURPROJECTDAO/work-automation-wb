...
| channel-margin-monitor (채널 가격·마진 모니터) | — | 운영중 (8채널 모니터 / 6채널 가격변경) | workflows/channel-margin-monitor.md |
