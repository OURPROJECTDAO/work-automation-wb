...
_갱신: 2026-06-17 (cashnote-register 1차 배치 87건 — 업로드감시 출력 직접 구동·판매가 네이버기준마진(없으면10%)·낱개매입가 master 보충·상품명 스마트 등록명 재활용 75/87·과세일괄. 카테고리 전체 294종표 추가(cashnote_category_all.csv·비식품 포함)로 86매핑/1빈칸(튀룽 제품불명). 사용자 확인: raw12 이름·피죤유연제 세탁세제 임시·실업로드)_
