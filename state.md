...
| dashboard (영업이익현황 대시보드) | 4 | 운영 · 매출 집계(구분/거래처/상품/관리코드) + 증분 업로더 · 3개년 313K행 · 차트/물류량 점진추가 | workflows/dashboard.md |
...
## 다음 한 수
- **Phase 4 대시보드 점진 확장**: 매출 집계 + 증분 업로더 배포 완료. 다음 후보 — ① 멀티연도 월별 매출 추이 차트 ② 이익률 KPI ③ 물류량(수량÷박스내품) ④ 이익/물류량 콤보 ⑤ 거래처 그룹 관리 탭. 사용자 우선순위 따라 1개씩. 상세 workflows/dashboard.md.
