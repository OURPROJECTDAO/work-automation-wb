...
_갱신: 2026-06-17 (cashnote-register 1차 배치 87건 — 카테고리 전건 매핑(전체 294종표·튀룽=디저트스낵). **상품군번호(AA) 품목별 교정: 가공식품 72건=21·비식품 15건(세제/세정제/유연제/물티슈)=37 생활화학제품**(기존 21 고정 버그). 판매가 네이버기준마진·낱개매입가 master·상품명 스마트명 재활용 75/87·과세일괄. 사용자 확인: raw12 이름·피죤유연제 세탁세제 임시·물티슈 군37 잠정·실업로드)_
