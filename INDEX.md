...
현재 워크플로우: openmarket-merge · onnuri-order · logistics-order · cheonnyeon-upload · invoice-fill · dashboard · product-registration-common(공통) · smartstore-register · easyadmin-register (state.md 인덱스 참조).
...
_갱신: 2026-06-09 (easyadmin-register 추가 — 이지어드민 정산채널)_
