...
현재 워크플로우: openmarket-merge · onnuri-order · logistics-order · cheonnyeon-upload · invoice-fill · dashboard · smartstore-register (state.md 인덱스 참조).
...
_갱신: 2026-06-09 (smartstore-register 추가. 워크플로우 목록 최신화)_
